...
public class IUSalarioEspecif extends javax.swing.JDialog {

    /**
     * Creates new form IUSalarioEspecif
     */
    public IUSalarioEspecif(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Funcionários com salário em faixa específica:");
        ...
        jLabel1.setText("Funcionários com salário em faixa específica:");
    ...
    private void btnListarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListarActionPerformed
        ...
        String aux = "\nFuncionário que recebem entre R$" + min + " e R$" + max + ".\n";
        Controlador control = new Controlador();
        textResumo.append(aux + control.salarioEspecifico(min, max));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IUSalarioEspecif.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
